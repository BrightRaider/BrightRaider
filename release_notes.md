...
V9.3 was downloaded over [**1,400 times**](https://github-release-stats.ghostbyte.dev/BrightRaider/BrightRaider) — if something were actually wrong, the internet would know about it by now. You can verify the V9.4 EXE yourself: [VirusTotal scan →](VIRUSTOTAL_LINK_HERE)
